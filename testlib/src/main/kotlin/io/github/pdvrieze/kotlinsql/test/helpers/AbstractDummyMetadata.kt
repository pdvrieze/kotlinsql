...
import io.github.pdvrieze.kotlinsql.ddl.columns.ILengthColumn
import java.sql.DatabaseMetaData
import java.sql.ResultSet
import java.sql.RowIdLifetime

abstract class AbstractDummyMetadata : DatabaseMetaData {
    ...
    override fun getTables(
        ...
        return connection.DummyResultSet("getTables()", columns, data)
    }
    ...
    override fun getColumns(
        ...
        return connection.DummyResultSet("metadata.getColumns()", columns, data)
    }
