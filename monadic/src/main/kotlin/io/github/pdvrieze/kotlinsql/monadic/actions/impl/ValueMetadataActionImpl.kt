...
internal class ValueMetadataActionImpl<DB : Database, out O> internal constructor(private val producer: (SafeDatabaseMetaData) -> O) :
    NoQueryActionImpl<DB, O>(), ValueMetadataAction<DB, O> {
