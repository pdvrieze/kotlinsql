...
import io.github.pdvrieze.kotlinsql.monadic.actions.LazyDataAction

internal class LazyDataActionImpl<DB : Database, O>(private val s: () -> O) : NoQueryActionImpl<DB, O>(), LazyDataAction<DB, O> {
