...
import io.github.pdvrieze.kotlinsql.monadic.actions.NoQueryAction

/**
 * Base class for actions that do not involve the database.
 */
internal abstract class NoQueryActionImpl<DB : Database, out O>() : DBActionImpl<DB, Unit, O>(), NoQueryAction<DB, O> {
