...
import io.github.pdvrieze.kotlinsql.ddl.columns.CharColumnConfiguration
import io.github.pdvrieze.kotlinsql.ddl.columns.LengthCharColumnConfiguration
import io.github.pdvrieze.kotlinsql.ddl.columns.DecimalColumnConfiguration
import io.github.pdvrieze.kotlinsql.ddl.columns.NumberColumnConfiguration
import io.github.pdvrieze.kotlinsql.ddl.columns.LengthColumnConfiguration
import io.github.pdvrieze.kotlinsql.ddl.columns.NormalColumnConfiguration
import io.github.pdvrieze.kotlinsql.ddl.columns.*
import io.github.pdvrieze.kotlinsql.ddl.impl.AbstractTable
...
abstract class MutableTable private constructor(name: String?,
    ...
    class __FOREIGN_KEY__6<T1 : Any, S1 : IColumnType<T1, S1, C1>, C1 : Column<T1, S1, C1>,
        ...
        fun REFERENCES(ref1: ColumnRef<T1, S1, C1>,
            ...
            (table.__foreignKeys).add(ForeignKey(listOf(col1, col2, col3, col4, col5, col6), ref1.table,
                                                 listOf(ref1, ref2, ref3, ref4, ref5, ref6).onEach {
    ...
    class __FOREIGN_KEY__5<T1 : Any, S1 : IColumnType<T1, S1, C1>, C1 : Column<T1, S1, C1>,
        ...
        fun REFERENCES(ref1: ColumnRef<T1, S1, C1>,
            ...
            (table.__foreignKeys).add(ForeignKey(listOf(col1, col2, col3, col4, col5), ref1.table,
                                                 listOf(ref1, ref2, ref3, ref4, ref5).onEach {
                                                     require(it.table == ref1.table)
                                                 }))
        }
    }
    ...
    class __FOREIGN_KEY__3<T1 : Any, S1 : IColumnType<T1, S1, C1>, C1 : Column<T1, S1, C1>,
        ...
        fun REFERENCES(ref1: ColumnRef<T1, S1, C1>,
            ...
            (table.__foreignKeys).add(ForeignKey(listOf(col1, col2, col3), ref1.table, listOf(ref1, ref2, ref3).onEach {
                require(it.table == ref1.table)
            }))
        }
    }
    ...
    inline fun <T1 : Any, S1 : IColumnType<T1, S1, C1>, C1 : Column<T1, S1, C1>,
            T2 : Any, S2 : IColumnType<T2, S2, C2>, C2 : Column<T2, S2, C2>
            > FOREIGN_KEY(col1: ColumnRef<T1, S1, C1>,
                          col2: ColumnRef<T2, S2, C2>
    ) =
