...
abstract class AbstractTable : Table {
    ...
    @PublishedApi
    internal fun <T : Any, S : IColumnType<T, S, C>, C : Column<T, S, C>> name(name: String,
                                                                               type: IColumnType<T, S, C>) =
            NamedFieldAccessor(name, type)

    @PublishedApi
    internal class NamedFieldAccessor<T : Any, S : IColumnType<T, S, C>, C : Column<T, S, C>>(val name: String,
                                                                                              type: IColumnType<T, S, C>) : TypeFieldAccessor<T, S, C>(
            type) {
